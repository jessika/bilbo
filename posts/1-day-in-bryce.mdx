...
thumbnail: "/images/1-day-in-bryce/bryce_point_forest-220x330.jpg"
---

<figure className="mdxFigure">
  <img
    alt="Forest view from Bryce Point"
    style={{ width: "100%" }}
    loading="eager"
    src="/images/1-day-in-bryce/bryce_point_forest-optimized.jpg"
  />
  <figcaption>Forest view from Bryce Point</figcaption>
</figure>
...
![View from Bryce Point](/images/1-day-in-bryce/bryce_viewfrombrycepoint-optimized.jpg)
